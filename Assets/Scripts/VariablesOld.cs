...
//    {
//        upgradeCrateDescription2[0] = "-your basic fire and \n forget missle";
//        upgradeCrateDescription2[1] = "-a multi shot version \n of the single shot";
//        upgradeCrateDescription2[2] = "-an energy beam of \n super destruction";
//        upgradeCrateDescription2[3] = "-an enemy seeking \n missile";
//        upgradeCrateDescription2[4] = "-a rapid fire turbo \n laser";
//        upgradeCrateDescription2[5] = "-an energy bomb that \n makes a bang";
//        upgradeCrateDescription2[6] = "-floating spheres of \n explosive goodness";
//        upgradeCrateDescription2[7] = "-its like a gigantic \n bandage";
//        upgradeCrateDescription2[8] = "-it refills your fire\n recharge rate";
//        upgradeCrateDescription2[9] = "-an energy shield that \n protects your planet";
//        upgradeCrateDescription2[10] = "-it slows down time";
//        upgradeCrateDescription2[11] = "-more cash money in \n your crates";
//        upgradeCrateDescription2[12] = "-start with more \nbombs";
//        upgradeCrateDescription2[13] = "-a orbiting defense \n satalite that helps \n kill the enemy";
//        upgradeCrateDescription2[14] = "-take less damage \n ";
//        upgradeCrateDescription2[15] = "-have more health \n ";
//        upgradeCrateDescription2[16] = "-faster health \nrecharge  ";
//        upgradeCrateDescription2[17] = "-more energy \n ";
//        upgradeCrateDescription2[18] = "-recharge enegy \nfaster  ";
//    }

//    public StoreManagerNewUI storeManagerUI;
//    public void ReturnCrateDescription()
//    {
//        /*upgradeCrateDescription[0] = "-your basic fire and \n forget missle";
//        upgradeCrateDescription[1] = "-a multi shot version \n of the single shot";
//        upgradeCrateDescription[2] = "-an energy beam of \n super destruction";
//        upgradeCrateDescription[3] = "-an enemy seeking \n missile";
//        upgradeCrateDescription[4] = "-a rapid fire turbo \n laser";
//        upgradeCrateDescription[5] = "-an energy bomb that \n makes a bang";
//        upgradeCrateDescription[6] = "-floating spheres of \n explosive goodness";
//        upgradeCrateDescription[7] = "-its like a gigantic \n bandage";
//        upgradeCrateDescription[8] = "-it refills your fire\n recharge rate";
//        upgradeCrateDescription[9] = "-an energy shield that \n protects your planet";
//        upgradeCrateDescription[10] = "-it slows down time";
//        upgradeCrateDescription[11] = "-more cash money in \n your crates";
//        upgradeCrateDescription[12] = "-start with more \nbombs";
//        upgradeCrateDescription[13] = "-a orbiting defense \n satalite that helps \n kill the enemy";
//        upgradeCrateDescription[14] = "-take less damage \n ";
//        upgradeCrateDescription[15] = "-have more health \n ";
//        upgradeCrateDescription[16] = "-faster health \nrecharge  ";
//        upgradeCrateDescription[17] = "-more energy \n ";
//        upgradeCrateDescription[18] = "-recharge enegy \nfaster  ";*/
//        //playerCurrentFireRate = singleFireRate - (upgradeLevel[0] * 0.075f); 
//        //playerCurrentEnergyRate = 40 - (40 * (upgradeLevel[0] * 0.25f));
//        //playerPowerTimer = 0;
...
//            //MainMenuManager.instance.statsBarManager.topBarStats[0] = new StatsInfo(50, _singleDamage, 50, _sdn);
//            storeManagerUI.SetStats(1, _singleFireRate, 2, _sfrn, "Fire Rate");
//            //MainMenuManager.instance.statsBarManager.middleBarStats[0] = new StatsInfo(2, _sfrn, 2, _singleFireRate);
//            storeManagerUI.SetStats(2, _singleEnergyRate, 120, _sdern, "Energy Rate");
//            //MainMenuManager.instance.statsBarManager.bottomBarStats[0] = new StatsInfo(120, _sdern, 120, _singleEnergyRate);
//            //MainMenuManager.instance.statsBars[0].SetStatsBar(10, 10, _singleDamage, _sdn);

//            upgradeCrateDescription[0] = "damage:" + _singleDamage + " -> " + _sdn + "\n\n" +
//                                            "fire rate:" + _singleFireRate + " -> " + _sfrn + "\n\n" +
//                                            "energy used:" + _singleEnergyRate + " -> " + _sdern;
//        }
//        else
//        {
...
//            MainMenuManager.instance.statsBarManager.topBarStats[0] = new StatsInfo(50, _singleDamage, 50, _singleDamage);
//            MainMenuManager.instance.statsBarManager.middleBarStats[0] = new StatsInfo(2, _singleFireRate, 2, _singleFireRate);
//            MainMenuManager.instance.statsBarManager.bottomBarStats[0] = new StatsInfo(120, _singleEnergyRate, 120, _singleEnergyRate);

//            //MainMenuManager.instance.statsBars[0].SetStatsBar(10, 10, _singleDamage, _singleDamage);
//            upgradeCrateDescription[0] = "damage: " + _singleDamage + "\n" +
//                                            "fire rate: " + _singleFireRate + "\n" +
//                                            "energy used: " + _singleEnergyRate;
//        }
